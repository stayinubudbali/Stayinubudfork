...
export default function HeroClient({ villas }: HeroClientProps) {
    ...
    return (
        <section ref={heroRef} className="relative h-screen min-h-[800px] overflow-hidden bg-gray-900">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <div className="overflow-hidden mb-4">
                                <motion.h1
                                    ...
                                    className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[0.95]"
                                >
                            ...
                            <div className="overflow-hidden mb-8">
                                <motion.h1
                                    ...
                                    className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl italic text-olive-400 leading-[0.95]"
                                >
                            ...
                            >
                                <Link
                                    ...
                                    className="group relative inline-flex items-center gap-3 px-8 py-4 bg-olive-600 text-white font-medium text-sm tracking-[0.15em] uppercase overflow-hidden"
                                >
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-8">
                            ...
                            <div className="flex items-center gap-4 md:gap-6">
                                <motion.button
                                    ...
                                    className="w-12 h-12 border border-white/30 flex items-center justify-center text-white/60 hover:text-white hover:border-white hover:bg-white/10 transition-all"
                                >
                                ...
                                <div className="flex items-center gap-3">
                                    {villas.map((_, index) => (
                                        <motion.button
                                            ...
                                            initial={false}
                                            animate={{ width: index === current ? 64 : 32 }}
                                ...
                                <div className="hidden md:flex items-center gap-2 text-white/40 text-sm font-mono ml-4">
                                    <span className="text-2xl text-white font-display">{String(current + 1).padStart(2, '0')}</span>
                            ...
                            <motion.div
                                ...
                                className="bg-white/95 backdrop-blur-sm p-5 md:p-6 shadow-2xl w-full lg:max-w-xl"
                            >
                                <div className="flex items-center gap-2 mb-4">
                                    <Calendar size={16} className="text-olive-600" />
                                    <span className="text-xs tracking-[0.2em] uppercase text-gray-500 font-medium">Check Availability</span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min={minDate}
                                            className="w-full px-3 py-3 border border-gray-200 text-sm focus:border-olive-600 outline-none transition-colors bg-gray-50 hover:border-gray-300"
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="w-full pl-8 pr-3 py-3 border border-gray-200 text-sm focus:border-olive-600 outline-none transition-colors bg-gray-50 appearance-none hover:border-gray-300"
                                            >
                                    ...
                                    <div className="flex items-end">
                                        <Link
                                            ...
                                            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-olive-600 text-white text-sm font-medium hover:bg-olive-900 transition-colors tracking-wider uppercase"
                                        >
                                            <Search size={16} />
                                            <span>Search</span>
                                        </Link>
            ...
            <motion.div
                ...
                className="absolute bottom-24 left-1/2 -translate-x-1/2 z-30 hidden lg:block"
            >
                <motion.div
                    animate={{ y: [0, 10, 0] }}
            ...
            <motion.div
                ...
                className="absolute bottom-40 right-20 z-30 hidden xl:flex items-center gap-3"
            >
                {villas.map((villa, index) => (
                    <motion.button
                        ...
                        className={`relative overflow-hidden transition-all duration-300 ${index === current
                            ? 'w-24 h-24 ring-2 ring-olive-400 ring-offset-2 ring-offset-gray-900'
